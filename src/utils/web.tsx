...
class WebRequest implements IRequest {
    ...
    initRequest(
        ...
        const {touchUrl, headers, withCredentials, mod} = ctx
        const opts = {credentials: withCredentials, params, headers, data: hexHash, mod}
    ...
    chunkRequest(
        ...
        this.request('post', ctx.uploadUrl, opts)
